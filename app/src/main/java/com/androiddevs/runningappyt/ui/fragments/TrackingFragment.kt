...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    private fun subscribeToObservers(){
        ...
        TrackingService.timeRunInMiliis.observe(viewLifecycleOwner, Observer {
            currentTimeInMillis = it
            val formattedTime = TrackinggUtility.getFormattedStopWatchTime(currentTimeInMillis,true)
    ...
    private fun upddateTracking(isTracking : Boolean) {
    ...
    private  fun endRunAndSaveToDb(){
        map?.snapshot { bmp ->
            ...
            for (polyline in pathPoints){
                distanceInMeters += TrackinggUtility.calculatePolylineLength(polyline).toInt()
            }
